...
base_path = "/content/drive/MyDrive/creators-copilot/src"
os.chdir(base_path)
...
pdf_name = "Manoj Pal_exam_answers.pdf"
...
if __name__ == "__main__":
    pages = extract_text_tables(data_path+pdf_name)
    qa_blocks = split_into_qas(pages)
